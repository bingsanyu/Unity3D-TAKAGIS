...
public var headBobSpeed: float = 0.0;
var isPaused: GameObject;

class CharacterMotorMovement {
	// The maximum horizontal speed when moving
	var walkspeed = 1.5;
var runspeed = 3.0;
var maxForwardSpeed = walkspeed;
var maxSidewaysSpeed = walkspeed;
var maxBackwardsSpeed = walkspeed;
...
function Update() {
	if (Input.GetKey("left shift")) {
		...
		movement.maxBackwardsSpeed = movement.runspeed;
	}
	else {
		movement.maxForwardSpeed = movement.walkspeed;
		movement.maxSidewaysSpeed = movement.walkspeed;
		movement.maxBackwardsSpeed = movement.walkspeed;
	}
	headBobSpeed = movement.maxForwardSpeed;
